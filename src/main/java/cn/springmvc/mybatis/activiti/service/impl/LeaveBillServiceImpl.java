...
public class LeaveBillServiceImpl implements LeaveBillService {
    ...
    public List<LeaveBill> findLeaveBillList() {
        List<LeaveBill> list = null;// leaveBillDao.findLeaveBillList();
        return list;
    }
    ...
    public void saveLeaveBill(LeaveBill leaveBill) {
        /*
         * //获取请假单ID Long id = leaveBill.getId();
         *//** 新增保存 */
        /*
         * if(id==null){ //1：从Session中获取当前用户对象，将LeaveBill对象中user与Session中获取的用户对象进行关联 leaveBill.setUser(SessionContext.get());//建立管理关系 //2：保存请假单表，添加一条数据 leaveBillDao.saveLeaveBill(leaveBill); }
         *//** 更新保存 *//*
                      * else{ //1：执行update的操作，完成更新 leaveBillDao.updateLeaveBill(leaveBill); }
                      */
